        ...
        <section className="mt-40">
            <div className="flex justify-between">
                ...
                <div className='md:w-1/2 relative'>
                    ...
                    <div className='bg-[#343268] text-white p-5 rounded-xl w-[395px] absolute -bottom-10 -left-14 '>
                       <h2 className='text-2xl mb-5'>Our mission is simple</h2>
                       <p className='text-lg'>To provide high-quality healthcare services that are accessible, personalized, and patient-centered.</p>
                    </div>
                </div>
            </div>
        </section>
